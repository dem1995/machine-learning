...
$$
\begin{align*}
p(\text{``The carnival-woman is clairvoyant"} | \text{3 right}) &= \frac{p(\text{3 right} | \text{``The carnival-woman is clairvoyant"}) \cdot p(\text{``The carnival-woman is clairvoyant"})}{p(\text{3 right})}
