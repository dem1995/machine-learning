...
Before these evevnts, Fatima believes that "clairvoyance isn't a thing" - however, with evidence, she's open to the idea the woman /might/ be clairvoyant. Her prior is strong - $$p(\unicode{x201C}\text{The carnival-woman is clairvoyant}\unicode{x201D}) = 1/1000)$$. Unlike Darcy, however, she updates her prior here-

$$
\begin{align*}
p(\unicode{x201C}\text{The carnival-woman is clairvoyant}\unicode{x201D} | \text{3 right}) &= \frac{p(\text{3 right} | \unicode{x201C}\text{The carnival-woman is clairvoyant}\unicode{x201D}) \cdot p(\unicode{x201C}\text{The carnival-woman is clairvoyant}\unicode{x201D})}{p(\text{3 right})}\\
                                                 &= \frac{1 \cdot \frac{1}{1000}}{p(\text{3 right} | \unicode{x201C}\text{The carnival-woman is clairoyant}\unicode{x201D})\cdot p(\unicode{x201C}\text{The carnival-woman is clairvoyant}\unicode{x201D}) + p(\text{3 right} | \unicode{x201C}\text{The carnival-woman is not clairoyant}\unicode{x201D}) \cdot p(\not\unicode{x201C}\text{The carnival-woman is clairvoyant\unicode{x201D})}}\\
